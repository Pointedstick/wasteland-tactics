...
\newcommand{\MissileLauncher}[1][4+]{\textbf{Missile Launcher}: R40 {#1} D6 [Deadly D10, Slow] or R40 A4 {#1} D1 [Area Effect, Slow]}
...
\newcommand{\GatlingGun}[1][4+]{\textbf{Gatling Gun}: R20 A3 {#1} D4 [Suppressive 2]}
\newcommand{\HeavyBattleRifle}[1][4+]{\textbf{Heavy Battle Rifle}: R30 A2 {#1} D3 [Suppressive 1]}
\newcommand{\LaserCannon}[1][4+]{\textbf{Laser Cannon}: R40 {#1} D8 [Critical 9+, Deadly D10, Slow]}
\newcommand{\MagmaCannon}[1][4+]{\textbf{Magma Cannon}: R16 {#1} D8 [Critical 8+, Deadly 2D5, Slow]}
\newcommand{\PlasmaCannon}[1][4+]{\textbf{Plasma Cannon}: R30 A3 {#1} D6, [Area Effect, Deadly 2, Unstable 1]}




% Vehicle-borne
\newcommand{\Autocannon}[1][3+]{\textbf{Autocannon}: R30 A2 {#1} D4 [Deadly 2, Slow]}
\newcommand{\FragLauncher}[1][4+]{\textbf{Frag Launcher}: R20 A6 {#1} D1 [Area Effect, Slow]}
\newcommand{\RocketArtillery}[1][4+]{\textbf{Rocket Artillery}: R10-40 A8 {#1} D2 [Area Effect, Indirect Fire, Slow, Suppressive 1]}


\newcommand{\SiegeCannon}[1][3+]{\textbf{Siege Cannon} R4-20 A8 {#1} D8 [Area Effect, Deadly D5+3, Slow, Terrifying 1]}
\newcommand{\TankGun}[1][5+]{\textbf{Tank Gun}: R8-40 A6 {#1} D5, [Area Effect, Deadly 2]}
\newcommand{\TwinAutocannon}[1][3+]{\textbf{Twin Autocannon}: R30 A4 {#1} D4 [Deadly 2, Slow]}
\newcommand{\TwinGatlingGun}[1][3+]{\textbf{Twin Gatling Gun}: R20 A8 {#1} D3 [Suppressive 2]}
\newcommand{\TwinHeavyBattleRifle}[1][3+]{\textbf{Twin Heavy Battle Rifle}: R30 A4 {#1} D3 [Suppressive 1]}
...
\begin{itemize}
     ...
     \item +20 points: \MissileLauncher
\end{itemize}
...
&
% Upgrades
+20 points: Replace Heavy Battle Rifle with \MagmaCannon[3+]

\hrulefill

Replace \textit{Transport 5} rule with one of the following:
\begin{itemize}
    \item +20 points: A second \HeavyBattleRifle[3+]
    \item +20 points: \HeavyFlamethrower
    \item +20 points: \GatlingGun[3+]
    \item +30 points: \MissileLauncher[3+]
\end{itemize}
