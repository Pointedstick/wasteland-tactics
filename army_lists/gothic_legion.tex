...
\newcommand{\CombatShotgun}[1][5+]{\textbf{Combat Shotgun}: R12 {#1} D2 [Assault, Rapid 2]}
\newcommand{\FlamePistols}{\textbf{Flame Pistols}: R6 Autohit D2 [Assault, Slow, Spray 5, Terrifying 1]}
\newcommand{\Flamethrower}{\textbf{Flamethrower}: R8 Autohit D2 [Assault, Slow, Spray 3, Terrifying 1]}
\newcommand{\GatlingGunMobile}[1][4+]{\textbf{Gatling Gun}: R20 {#1} D4 [Rapid 3, Suppressive 2]}
\newcommand{\Grenades}[1][5+]{\textbf{Grenades}: R8 {#1} D1 [Area Effect 3, Assault, Suppressive 0]}
\newcommand{\HeavyBattleRifleMobile}[1][4+]{\textbf{Heavy Battle Rifle}: R30 {#1} D3 [Rapid 2, Suppressive 1]}
...
\newcommand{\MagmaPistols}[1][5+]{\textbf{Magma Pistols}: R4 {#1} D8 [Assault, Critical 8+, Deadly 2D5, Rapid 2, Slow]}
\newcommand{\MissileLauncherMobile}[1][4+]{\textbf{Missile Launcher}: Choose a type each time it fires:
\begin{itemize}
    \item Frag missile: R40 {#1} D1 [Area Effect 4, Heavy, Slow]
    \item Anti-tank missile: R40 {#1} D6 [Deadly D10, Heavy, Slow]
\end{itemize}
}
\newcommand{\PlasmaCannonMobile}[1][4+]{\textbf{Plasma Cannon}: R30 {#1} D6, [Area Effect 3, Deadly 2, Unstable 1]}
\newcommand{\SniperRifle}[1][3+]{\textbf{Sniper Rifle}: R30 {#1} D6 [Critical 8+, Deadly 2, Heavy, Sniper, Terrifying 1]}
\newcommand{\StormRifle}[1][5+]{\textbf{Storm Rifle}: R20 {#1} D2 [Assault, Rapid 2]}
...
\newcommand{\MissileLauncher}[1][3+]{\textbf{Missile Launcher}: Choose a type each time it fires:
\begin{itemize}
    \item Frag missile: R40 {#1} D1 [Area Effect 4, Heavy, Slow]
    \item Anti-tank missile: R40 {#1} D6 [Deadly D10, Heavy, Slow]
\end{itemize}
