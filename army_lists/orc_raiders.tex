...
% -------------
% Handheld
\newcommand{\BruteWeapon}[1][3+]{\textbf{Brute Weapon}: A2 {#1} D1}
...
\newcommand{\ClawsAndTeeth}[1][3+]{\textbf{Claws and Teeth}: A2 {#1}}
\newcommand{\CuttingTorch}[1][4+]{\textbf{Cutting Torch}: {#1} D5 [Deadly 2, Slow]}
\newcommand{\GunBludgeoning}[1][4+]{\textbf{Gun (Bludgeoning)}: {#1}}
\newcommand{\HugeBossChopper}[1][2+]{\textbf{Huge Boss Chopper}: A4 {#1} D4 [Deadly 2]}
\newcommand{\HugeBruteChopper}[1][2+]{\textbf{Huge Brute Chopper}: A2 {#1} D3 [Deadly 2]}
\newcommand{\Knife}[1][4+]{\textbf{Knife}: {#1}}
\newcommand{\PoweredBossWeapon}[1][3+]{\textbf{Powered Boss Weapon}: A2 {#1} D6 [Deadly D5+1]}
\newcommand{\PoweredBruteWeapon}[1][4+]{\textbf{Powered Brute Weapon}: {#1} D6 [Deadly D5]}
\newcommand{\RustyBlade}[1][7+]{\textbf{Rusty Blade}: {#1}}

% Vehicle-borne
\newcommand{\ChoppyBlades}[1][4+]{\textbf{Choppy Blades}: A5 {#1} D2}
\newcommand{\PoweredWeapon}[1][3+]{\textbf{Powered Weapon}: A2 {#1} D6 [Deadly D5+1] (each additional one increased the A value by 2)}
\newcommand{\SpikyRam}[1][4+]{\textbf{Spiky Ram}: {#1} D5 [Deadly 4]}
\newcommand{\KillRoller}[1][4+]{\textbf{Kill Roller} A6 {#1} D3 [Area Effect, Deadly 2, Suppressive 1]}
...
\newcommand{\RocketLaunchers}[1][7+]{\textbf{Rocket Launchers}: R20 A2 {#1} D3 [Deadly D10-2 (min 1), Heavy, Slow]}
