...
\subsubsection*{5 Limited visibility:} Units that opt to move faster than 6'' during a Move or Fight action count as being inside Dangerous Terrain 9+, and every unit suffers a -1 Shoot penalty for each full 10'' separating the firing unit and its target.
...
\subsubsection*{7 Rainy:} Apply the penalties of both the ``Limited Visibility'' and ``Muddy/Swampy'' conditions.
