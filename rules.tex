...
\subsubsection*{Critical:} This weapon is capable of dealing terrible damage with a lucky hit. If it would automatically hit, roll anyway. For each die that shows a 10, the target fails a life roll automatically.
