...
Similarly, when a unit with more than 3 models takes a Shoot action, if it has a tabletop footprint that is at least twice as deep as it is wide from the perspective of the target unit, it gains a +1 Shoot bonus.
