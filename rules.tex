...
\subsubsection*{Vehicle/Monster X:} This unit is a vehicle or monster. It never takes Morale tests, makes Forced Move Actions,  accumulates Suppression markers, takes Defend actions, embarks on transports, or gains life bonuses from Cover.
...
When the unit makes a Fight action that would bring it into base contact with a non-Vehicle/Monster unit, then after it moves, each target unit must pass a Will roll or else take a Forced Move Action away from it instead of being attacked.
