...
\subsubsection*{Unstable X:} This weapon may explode! If it would automatically hit, roll anyway. For each die that shows an X or lower, the firing model fails a Life roll.
