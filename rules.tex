...
\subsubsection*{Pathbound:} This model becomes bogged down out of open ground. In difficult terrain, you must choose whether to apply a Move penalty of -6, or else count the area as Dangerous Terrain 9.
...
\subsubsection*{Leadership X:} This unit includes a commander or important officer capable of inspiring your forces. It may issue up to X number of the following Orders per round, at any time, to units in the same Battle Group that have at least one model within 6''. The unit may extend this range to 18'' by passing a Will roll; but if the roll fails, the order is wasted.
...
Units receive a penalty of -2 Move during Move or Fight actions that take any of their models into, out of, or through areas of Difficult Terrain. Units that move through multiple areas of Difficult Terrain use the worst penalties rather than combining them.
