...
\begin{itemize}
    \item \textbf{R[number]:} The weapon's range. A weapon with a Range of 0 is a melee weapon; otherwise, it is a ranged weapon. If there are two numbers, the first one is a minimum range.
