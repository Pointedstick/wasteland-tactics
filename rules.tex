...
\subsubsection*{Sniper:} This weapon may be used to fire at models with the Leadership rule that are not the closest visible target. When the weapon scores any hits on multi-unit models, you may choose which models to allocate Life rolls to. However the weapon's Damage value is reduced to 0 against Vehicles without the Open rule.
