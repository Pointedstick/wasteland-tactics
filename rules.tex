...
When the unit makes a Fight action that would bring it into base contact with a non-Vehicle/Monster unit, target units may not exercise the option to make a Go to Ground Reaction.
