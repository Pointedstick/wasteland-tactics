...
A unit may embark on a Transport model by using a Move action to place all of its models within 3'' of it. Embarked units are removed from the battlefield, cannot be interacted with, and may take no action except to disembark.
