...
\subsubsection*{4. Critical objective:} Agree upon a single piece of terrain not within any player's deployment zone to be the critical objective that must be controlled at all costs. The winner is the first player to have at least two scoring units within 6" of the objective and no enemy models within that same distance at the end of two consecutive rounds.
...
\begin{enumerate}
    ...
    \item Units with two Suppression markers get no actions and cannot be activated at all.
\end{enumerate}
...
Units with any suppression markers on them always count as taking a Defend action, no matter what other action they take.
