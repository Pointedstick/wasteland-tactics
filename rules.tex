...
When the unit makes a Fight action that would bring it into base contact with a non-Vehicle/Monster unit, then after it moves, each target unit must pass a Will roll or else take a Forced Move Action away from it. 
