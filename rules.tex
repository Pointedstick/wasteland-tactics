...
The unit must pass a Will roll to undertake any or all of the following advanced shooting tasks:
...
A failed roll prevents the unit from performing those advanced shooting tasks, and the resulting confusion imposes a -1 Shoot penalty for the remainder of the Action.
