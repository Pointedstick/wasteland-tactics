...
A unit may embark on a Transport model by using a Move action to place all of its models on top of or within 3'' of it. Embarked units are removed from the battlefield, cannot be interacted with, and may take no action except to disembark.
...
\subsubsection*{Indirect Fire:} This weapon may suffer a -2 Shoot penalty to be able to target units that are not visible to its firer but are visible to and have any models within 15'' of a friendly Spearhead or Scouts unit.
