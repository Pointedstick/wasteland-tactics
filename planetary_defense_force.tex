...
%FIXME: default hit value should be 7+ since it's an assault weapon
\newcommand{\Carbine}[1][6+]{Carbine: R15 A2 {#1} D0 [Assault]} 
...
\begin{itemize}
    \item \Rifle[5+]
    \item \CombatKnife[5+]
    \item One model also has an \EnergySword
\end{itemize}
&
% Special rules
...
% Weapons
\begin{itemize}
    \item \HugeMeleeWeapon
    \item \HugeCombatShotgun
\end{itemize}
&
% Special rules
...
\begin{itemize}
    \item \Rifle
    \item \CombatKnife
    % FIXME: HMG should be crew-served
